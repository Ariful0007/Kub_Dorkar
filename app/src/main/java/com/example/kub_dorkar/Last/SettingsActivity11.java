package com.example.kub_dorkar.Last;
...
public class SettingsActivity11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings11);
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                Refdatabase.child("Users").child(currentUserrID).child("image")
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        {
                                            Toast.makeText(SettingsActivity11.this, "Image saved in database successfuly", Toast.LENGTH_SHORT).show();
                                        }
                                        else
                                        {
                                            String message = task.getException().toString();
                                            Toast.makeText(SettingsActivity11.this, "Error: " + message,Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            }
    ...
    private void UpdateSettings() {
        ...
        {
            Toast.makeText(SettingsActivity11.this,"Please write your user name first...",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(setuserstatus))
        {
            Toast.makeText(SettingsActivity11.this,"Please write your status first...",Toast.LENGTH_SHORT).show();
        }
        else
        {
            ...
            Refdatabase.child("Users").child(currentUserrID).updateChildren(profileMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful())
                    {
                        Toast.makeText(SettingsActivity11.this,"Your profile has been updated...",Toast.LENGTH_SHORT).show();
                        sendUserToMainActivity();
                    }
                    else
                    {
                        String errormessage=task.getException().toString();
                        Toast.makeText(SettingsActivity11.this,"Error :"+errormessage,Toast.LENGTH_SHORT).show();
                    }
                }
            });
    ...
    private void sendUserToMainActivity() {
        Intent mainIntent=new Intent(SettingsActivity11.this,MainActivity1.class);
    ...
    private void RetrieveUserInfo() {
        ...
        Refdatabase.child("Users").child(currentUserrID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    Toast.makeText(SettingsActivity11.this,"Please set and update your profile information...",Toast.LENGTH_SHORT).show();
                }
            }
