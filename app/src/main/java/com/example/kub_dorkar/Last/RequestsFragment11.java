...
public class RequestsFragment11 extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<Contacts1> options=new FirebaseRecyclerOptions.Builder<Contacts1>()
                .setQuery(chatrequestRef.child(currentUserId),Contacts1.class)
                .build();

        FirebaseRecyclerAdapter<Contacts1,RequestViewHolder> adapter=new FirebaseRecyclerAdapter<Contacts1, RequestViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final RequestViewHolder holder, int position, @NonNull Contacts1 model) {
