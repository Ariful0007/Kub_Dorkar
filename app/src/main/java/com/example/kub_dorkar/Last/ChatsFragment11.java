...
public class ChatsFragment11 extends Fragment {
    ...
    public void onStart() {
        super.onStart();
        FirebaseRecyclerOptions<Contacts1> options=new FirebaseRecyclerOptions.Builder<Contacts1>()
                .setQuery(chatRef,Contacts1.class).build();

        FirebaseRecyclerAdapter<Contacts1,ChatViewHolder> adapter=new FirebaseRecyclerAdapter<Contacts1, ChatViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final ChatViewHolder holder, int position, @NonNull Contacts1 model) {
                        ...
                        if(dataSnapshot.exists())
                        {
                            ...
                            holder.itemView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent chatIntent=new Intent(getContext(),ChatActivity11.class);
