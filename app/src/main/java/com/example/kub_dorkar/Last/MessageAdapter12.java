...
public class MessageAdapter12 extends RecyclerView.Adapter<MessageAdapter12.MessageViewHolder> {

    private List<Messages12> UserMessageList;
    private DatabaseReference userRef;
    private FirebaseAuth mAuth;
    public MessageAdapter12 (List<Messages12> UserMessageList)
    {
    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder holder, final int position) {
        ...
        final Messages12 messages=UserMessageList.get(position);
