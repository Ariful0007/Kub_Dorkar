...
public class ChatActivity11 extends AppCompatActivity {
    ...
    private final List<Messages12> messagesList=new ArrayList<>();
    private LinearLayoutManager linearLayoutManager;
    private MessageAdapter12 messageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat11);
        ...
        messageAdapter=new MessageAdapter12(messagesList);
        ...
        sendFileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder=new AlertDialog.Builder(ChatActivity11.this);
        ...
        RootRef.child("Messages").child(messageSenderId).child(messageRecieverId).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                Messages12 messages=dataSnapshot.getValue(Messages12.class);
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        filepath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                loadingBar.dismiss();
                                Toast.makeText(ChatActivity11.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            RootRef.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    ...
                                    {
                                        loadingBar.dismiss();
                                        Toast.makeText(ChatActivity11.this,"Error:",Toast.LENGTH_SHORT).show();
                                    }
